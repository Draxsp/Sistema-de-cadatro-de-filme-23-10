...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17/10/2025 às 22:12
...
--
ALTER TABLE `tbator`
  MODIFY `codAtor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tbdiretorfilme`
  MODIFY `codDiretorFilme` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `tbfilme`
--
ALTER TABLE `tbfilme`
  MODIFY `codFilme` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `tbgenerofilme`
--
ALTER TABLE `tbgenerofilme`
  MODIFY `codGeneroFilme` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
